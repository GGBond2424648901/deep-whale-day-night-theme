...
1. Download `deep-whale-day-night-theme-v0.1.0.zip` and `SHA256SUMS.txt` from the [v0.1.0 release](https://github.com/GGBond2424648901/deep-whale-day-night-theme/releases/tag/v0.1.0).
...
```sh
dsh plugin --profile web add /absolute/path/to/deep-whale-day-night-theme-v0.1.0
```
